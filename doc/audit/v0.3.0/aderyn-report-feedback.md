...
## L-2: Unspecific Solidity Pragma (19 instances) — Accepted, intentional
...
`0.8.34` (`hardhat.config.ts`). The count increased from 13 to 19 compared to
v0.2.0 because all 19 in-scope contracts are now captured by the tool.

No code change required.

---

## L-3: PUSH0 Opcode (19 instances) — Not applicable
...
## L-5: Empty Block (21 instances) — Accepted, intentional
...
| L-2 Unspecific Pragma | 19 | Accepted — compatibility with OZ Confidential submodule |
| L-3 PUSH0 Opcode | 19 | Not applicable — mainnet target, `prague` EVM |
| L-4 Modifier Invoked Only Once | 3 | Accepted — intentional module auth pattern |
| L-5 Empty Block | 21 | Accepted — intentional hooks and extension points |
